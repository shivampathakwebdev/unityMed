...
$con=mysqli_connect("localhost","root","","myhmsdb");
  ...
  if (isset($_POST['app-submit'])) {
    ...
    if (isset($_SESSION['pid'], $_SESSION['username'], $_SESSION['email'], $_SESSION['fname'], $_SESSION['lname'], $_SESSION['gender'], $_SESSION['contact'])) {
        $pid = $_SESSION['pid'];
        $username = $_SESSION['username'];
        $email = $_SESSION['email'];
        $fname = $_SESSION['fname'];
        ...
        $docFees = isset($_POST['docFees']) ? $_POST['docFees'] : '';
        ...
        if (strtotime($appdate) >= strtotime(date("Y-m-d"))) {
            ...
            if ((strtotime($appdate) > strtotime(date("Y-m-d"))) || (strtotime($appdate) == strtotime(date("Y-m-d")) && strtotime($apptime) > strtotime(date("H:i:s")))) {
                // Database connection
                $con=mysqli_connect("localhost","root","","myhmsdb");
                ...
                if ($con) {
                    ...
                    $docFees = mysqli_real_escape_string($con, $docFees);
                    $appdate = mysqli_real_escape_string($con, $appdate);
                    $apptime = mysqli_real_escape_string($con, $apptime);
                    ...
                    if (mysqli_num_rows($check_query) == 0) {
                        ...
                        $query = mysqli_query($con, "INSERT INTO appointmenttb(pid,fname,lname,gender,email,contact,hospital_name,doctor,docFees,appdate,apptime,userStatus,doctorStatus) VALUES($pid,'$fname','$lname','$gender','$email','$contact','$hospital_name','$doctor','$docFees','$appdate','$apptime','1','1')");
...
if(isset($_GET["generate_bill"])){
  ...
  $content .= '
      <br/>
      <h2 align ="center"> UnityMed </h2></br>
...
<div class="col-md-8">
    <input class="form-control" type="text" name="spec" id="spec" readonly="readonly"/>
</div><br><br>
...
<div class="col-md-8">
  <input class="form-control" type="text" name="hospital_name" id="hospital_name" >
</div><br><br>
              ...
              <table class="table table-hover">
                ...
                <tbody>
                  <?php 
                    ...
                    $query = "select ID,doctor,hospital_name,docFees,appdate,apptime,userStatus,doctorStatus from appointmenttb where fname ='$fname' and lname='$lname';";
