...
{
  $email=$_POST['email'];
  $query="delete from hospital where hospital_email='$email';";
...
<html lang="en">
  ...
  <a class="navbar-brand" href="#"><i class="fa fa-user-plus" aria-hidden="true"></i> UnityMed </a>
...
.btn-primary{
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
     <ul class="navbar-nav mr-auto">
       ...
       <li class="nav-item">
       <a class="nav-link" href="admin-panel1.php"><i class="fa fa-sign-out" aria-hidden="true"></i>Back</a>
      </li>
    </ul>
  </div>
</nav>
  ...
  <body style="padding-top:50px;">
   <div class="container-fluid" style="margin-top:50px;">
    <h3 style = "margin-left: 40%; padding-bottom: 20px;font-family: 'IBM Plex Sans', sans-serif;"> Welcome Back Admin. </h3>
    <div class="row">
  <div class="col-md-4" style="max-width:25%;margin-top: 3%;">
    <div class="list-group" id="list-tab" role="tablist">
      ...
      <a class="list-group-item list-group-item-action" href="#list-hos" id="list-hos-list"  role="tab"    aria-controls="home" data-toggle="list">Hospital List</a>
  ...
  <div class="col-md-8" style="margin-top: 3%;">
    <div class="tab-content" id="nav-tabContent" style="width: 950px;">
        ...
        <div class="container-fluid container-fullw bg-white" >
              <div class="row">
               <div class="col-sm-4">
                ...
                <div class="col-sm-4">
                  <div class="panel panel-white no-radius text-center">
                    ...
                    <span class="fa-stack fa-2x"> <i class="fa fa-square fa-stack-2x text-primary"></i> <i class="fa fa-plus fa-stack-1x fa-inverse"></i> </span>
                      ...
                      <p class="links cl-effect-1">
                        <a href="#list-hos" onclick="clickDiv('#list-hos-list')">
                          View Hospitals
                        </a>
                      </p>
                    </div>
                ...
                <div class="row">
                <div class="col-sm-4" style="left: 20%;margin-top: 15%;">
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body" >
                ...
                <div class="col-sm-4" style="left: 55%; margin-top: 10%;">
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body" >
                ...
                <div class="col-sm-4" style="left: 20%;margin-top: 8%">
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body" >
                      <span class="fa-stack fa-2x"> <i class="fa fa-square fa-stack-2x text-primary"></i> <i class="fa fa-plus fa-stack-1x fa-inverse"></i> </span>
      ...
      <div class="tab-pane fade" id="list-hos" role="tabpanel" aria-labelledby="list-home-list">
              

              <div class="col-md-8">
      <form class="form-group"  action="hospitalsearch.php" method="post">
        <div class="row">
        <div class="col-md-10"><input type="text" name="hospital_email" placeholder="Enter Email ID" class = "form-control"></div>
      ...
      <div class="tab-pane fade" id="list-settings" role="tabpanel" aria-labelledby="list-settings-list">
        <form class="form-group" method="post" action="admin-panel1.php">
          <div class="row">
                  ...
                  <div class="col-md-8"><input type="text" class="form-control hospital-name" placeholder="Hospital Name" name="hospital_name" required=""></div><br><br>
                  <div class="col-md-4"><label>Hospital Address:</label></div>
                  <div class="col-md-8"><input type="text" class="form-control hospital-add" placeholder="Hospital Address" name="add" required=""></div><br><br>
                  <div class="col-md-4"><label>Contact:</label></div>
                  <div class="col-md-8"><input type="text" class="form-control" name="contact" minlength="10" maxlength="10" placeholder="Contact No" required=""></div><br><br>
                  <div class="col-md-4"><label>Email ID:</label></div>
                  <div class="col-md-8"><input type="email" class="form-control" name="email" placeholder="E-mail Address" required="" data-gtm-form-interact-field-id="2"></div><br><br>
                  <div class="col-md-4"><label>Password:</label></div>
                  <div class="col-md-8"><input type="password" class="form-control" placeholder="Password *" id="password" name="password" required="" data-gtm-form-interact-field-id="3"></div><br><br>
                  <div class="col-md-4"><label>Confirm Password:</label></div>
                  <div class="col-md-8"><input type="password" class="form-control" id="cpassword" placeholder="Confirm Password *" name="cpassword" required="">&nbsp;&nbsp;<span id='message'></span>
                </div><br><br>
                </div>
                              
               
          <!--input type="submit" class="btn btn-primary" name="register" onclick="return checklen();" value="Add Hospital"-->
          <input type="submit" class="btn btn-primary" name="register"  value="Add Hospital">
        </form>
      </div>
      ...
      <div class="tab-pane fade" id="list-settings1" role="tabpanel" aria-labelledby="list-settings1-list">
        <form class="form-group" method="post" action="admin-panel1.php">
          <div class="row">
                  ...
                  <div class="col-md-4"><label>Email ID:</label></div>
                  <div class="col-md-8"><input type="text" class="form-control" name="email" placeholder="E-mail Address" required="" data-gtm-form-interact-field-id="2"></div><br><br>
                  
                </div>
          <input type="submit" name="register1" value="Delete Hospital" class="btn btn-primary" onclick="confirm('do you really want to delete?')">
        </form>
      </div>
